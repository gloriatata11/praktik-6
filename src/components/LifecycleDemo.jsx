...
const LifecycleDemo = () => {
  ...
  useEffect(() => {
    console.log('Effect tanpa dependencies - dijalankan setelah setiap setiap render');
  });
  ...
  return (
    <div className="lifecycle-demo">
      ...
      <div className="explanation">
        ...
        <p>Buka Developer Tools (F12) dan lihat console untuk melihat
        kapan effects dijalankan</p>
      </div>
    </div>
  );
};
